...
public class EpsGraphics extends java.awt.Graphics2D {
     ...
     */
    public EpsGraphics(String title, OutputStream outputStream, int minX, int minY, int maxX, int maxY,
    ...
    // // new EpsGraphics(doc.getTitle(), doc.getStream(), (int) doc.getMinX(),
    // (int) doc.getMinY(), (int) doc.getMaxX(),
    // // (int) doc.getMaxY(), colorMode);
    //       
    // }
...
//        System.err.println("G: " + g._document);
    ...
    private void methodNotSupported() {
        throw new RuntimeException("Method not currently supported by EpsGraphics2D version " + VERSION);
    }
    ...
    /**
     * Sets the rendering hints. These are ignored by EpsGraphics.
     */
    @Override
    ...
    /**
     * Adds rendering hints. These are ignored by EpsGraphics.
     */
    @Override
    ...
    /**
     * Concatenates the current EpsGraphics Transformation with a translation
     * transform.
     */
    @Override
    ...
    /**
     * Concatenates the current EpsGraphics Transform with a rotation transform.
     */
    @Override
    ...
    /**
     * Concatenates the current EpsGraphics Transform with a translated rotation
     * transform.
     */
    @Override
    ...
    /**
     * Concatenates the current EpsGraphics Transform with a scaling
     * transformation.
     */
    @Override
    ...
    /**
     * Concatenates the current EpsGraphics Transform with a shearing transform.
     */
    @Override
    ...
    /**
     * Composes an AffineTransform object with the Transform in this EpsGraphics
    ...
    /**
     * Sets the AffineTransform to be used by this EpsGraphics.
     */
    @Override
    ...
    /**
     * Gets the AffineTransform used by this EpsGraphics.
     */
    ...
    /**
     * Returns the current Paint of the EpsGraphics object.
     */
    ...
    public void setColor(Color color) {
        ...
        case BLACK_AND_WHITE:
            ...
            break;
        case GRAYSCALE:
            double grayvalue = ((color.getRed() + color.getGreen() + color.getBlue()) / (3 * 255f));
            append(grayvalue + " setgray");
            break;
        case COLOR_RGB:
            append((color.getRed() / 255f) + " " + (color.getGreen() / 255f) + " " + (color.getBlue() / 255f)
                    + " setrgbcolor");
            break;
        case COLOR_CMYK:
            if (color.equals(Color.BLACK)) {
                ...
                append((c - k) / (1 - k) + " " + (m - k) / (1 - k) + " " + (y - k) / (1 - k) + " " + k
                        + " setcmykcolor");
            }
            break;
    ...
    public boolean drawImage(Image img, int dx1, int dy1, int dx2, int dy2, int sx1, int sy1, int sx2, int sy2,
        ...
        // bitsPerSample = "true";
        // }
        append(width + " " + height + " " + bitsPerSample + " [" + m[0] + " " + m[1] + " " + m[2] + " " + m[3] + " "
                + m[4] + " " + m[5] + "]");
